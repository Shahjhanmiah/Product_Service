        ...
        <div>
            <section className="flex items-center h-full sm:p-16 dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="w-16 h-16 border-4 border-dashed rounded-full animate-spin bg-green-500"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-40 h-40 dark:text-gray-600 bg-green-300">
                    ...
                    <p className="text-3xl">Looks like our services  is not route match
                    than error page </p>
