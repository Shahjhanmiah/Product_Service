...
const Advertisedetails = ({ service }) => {
		...
		<div>
			<div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
				<div className="flex space-x-4">
					<img alt="" src={catagori} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
				...
				<div>
					<img src={catagori} alt="" className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
